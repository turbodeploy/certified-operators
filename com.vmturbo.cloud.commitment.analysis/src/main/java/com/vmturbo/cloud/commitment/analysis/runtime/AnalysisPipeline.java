...
public class AnalysisPipeline {
     ...
     * @param <NextStageInput> The expected input for the next stage passed to {@link Builder#addStage(AnalysisStage)}.
     */
    public static class Builder<NextStageInput> {
         ...
         * @param <NewStageOutput> The output of {@code stage}, which will be used as the expected
         *                        input for the next stage.
         * @return This {@link Builder} instance for method chaining.
         */
        @Nonnull
        public <NewStageOutput> Builder<NewStageOutput> addStage(
                @Nonnull AnalysisStage<NextStageInput, NewStageOutput> stage) {

            stages.add(Objects.requireNonNull(stage));

            return (Builder<NewStageOutput>)this;
        }
