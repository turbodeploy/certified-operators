...
public class DemandOverriddenCommodityEditorTest {
    TopologyEntity.Builder pm1 = TopologyEntity.newBuilder(new TopologyEntityImpl()
            .setOid(1111)
            ...
            .addCommoditySoldList(new CommoditySoldImpl()
                    ...
                    .setUsed(15)
                    .setPeak(20)
                    .setHistoricalUsed(new HistoricalValuesImpl()
                            .setHistUtilization(10))
                    .setHistoricalPeak(new HistoricalValuesImpl()
                            .setHistUtilization(15))));
    TopologyEntity.Builder pm2 = TopologyEntity.newBuilder(new TopologyEntityImpl()
            .setOid(1112)
            .setEntityType(EntityType.PHYSICAL_MACHINE_VALUE)
            .addCommoditySoldList(new CommoditySoldImpl()
                    .setCommodityType(new CommodityTypeImpl()
    ...
    TopologyEntity.Builder vm1 = TopologyEntity.newBuilder(new TopologyEntityImpl()
            ...
            .addCommoditiesBoughtFromProviders(new CommoditiesBoughtFromProviderImpl()
                    ...
                    .addCommodityBought(new CommodityBoughtImpl()
                            ...
                            .setUsed(10)
                            .setPeak(20)
                    .setHistoricalUsed(new HistoricalValuesImpl().setHistUtilization(15))
                    .setHistoricalPeak(new HistoricalValuesImpl().setHistUtilization(25))))
            .addCommoditySoldList(new CommoditySoldImpl()
                    .setUsed(5)
                    .setPeak(10)
                    .setCapacity(10000)
                    .setHistoricalUsed(new HistoricalValuesImpl().setHistUtilization(8))
                    .setHistoricalPeak(new HistoricalValuesImpl().setHistUtilization(18))
                    .setCommodityType(new CommodityTypeImpl()
                            .setType(CommodityDTO.CommodityType.VMEM_VALUE))));
    TopologyEntity.Builder vm2 = TopologyEntity.newBuilder(new TopologyEntityImpl()
        .setOid(0002)
        .setEntityType(EntityType.VIRTUAL_MACHINE_VALUE)
        .addCommoditiesBoughtFromProviders(new CommoditiesBoughtFromProviderImpl()
    ...
    public void testApplyDemandUsageChangeGlobally() throws Exception {
        ...
        Assert.assertTrue(vm1.getTopologyEntityImpl().getCommoditySoldListList().get(0).getHistoricalUsed()
                .getHistUtilization() == 12);
        Assert.assertTrue(vm1.getTopologyEntityImpl().getCommoditySoldListList().get(0).getHistoricalPeak()
        ...
        Assert.assertTrue(vm1.getTopologyEntityImpl().getCommoditiesBoughtFromProvidersImplList().get(0)
        ...
        Assert.assertTrue(pm1.getTopologyEntityImpl().getCommoditySoldList(0).getHistoricalUsed()
                .getHistUtilization() == 14);
        Assert.assertTrue(pm1.getTopologyEntityImpl().getCommoditySoldList(0).getHistoricalPeak()
        ...
        Assert.assertTrue(vm2.getTopologyEntityImpl().getCommoditySoldListList().get(0).getUsed() == 7.5);
        Assert.assertTrue(vm2.getTopologyEntityImpl().getCommoditySoldListList().get(0).getPeak() == 12);
        ...
        Assert.assertTrue(vm2.getTopologyEntityImpl().getCommoditiesBoughtFromProvidersImplList().get(0)
        ...
        // 30 + 4 = 34
        Assert.assertTrue(pm2.getTopologyEntityImpl().getCommoditySoldList(0).getUsed() == 22.5);
        Assert.assertTrue(pm2.getTopologyEntityImpl().getCommoditySoldList(0).getPeak() == 34);
    }
