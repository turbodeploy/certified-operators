 ...
 */
public class V_01_00_04__Add_UI_Category_and_license_To_Probes_MigrationTest {
    ...
    private V_01_00_04__Add_UI_Category_and_license_To_Probes_Migration migration;
    ...
    public void setUp() {
        Mockito.when(kvStore.getByPrefix(ProbeStore.PROBE_KV_STORE_PREFIX))
                .thenReturn(PROBES);
        migration = new V_01_00_04__Add_UI_Category_and_license_To_Probes_Migration(kvStore);
    }
