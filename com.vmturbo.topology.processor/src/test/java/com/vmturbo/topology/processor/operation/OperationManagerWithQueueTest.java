...
public class OperationManagerWithQueueTest {
    ...
    public void testGetInProgressDiscoveryForTarget(DiscoveryType discoveryType) throws Exception {
        ...
        // DiscoveryResponse.
        runDiscoveryWithResult(target1Id, discoveryType, () -> cleanupRun.set(true),
    ...
    public void testSendDiscoveryContext(DiscoveryType discoveryType) throws Exception {
       ...
       final Pair<IDiscoveryQueueElement, DiscoveryBundle> pair1 = runDiscoveryWithResult(target1Id, discoveryType, () -> { },
                result);

        // sleep briefly to allow operationManager to process discovery on a different thread
        Thread.sleep(100L);
