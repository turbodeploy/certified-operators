...
public class MediationComponentMainTest extends MediationComponentMain {
    ...
    private static final String ZIP_STREAM_ENTRIES_FIELD = "names";
    private static final String TMP_AWS_BILLING_PATH = "/tmp/diags/aws/billing/";
    private static final String MOCK_DIAGS_FILE = "mockBillingDiags";
