...
public class PercentileEditor extends
    ...
    private static final Map<EntityType, Set<CommodityType>> ENABLED_BOUGHT_FROM_PROVIDER_TYPES =
            ImmutableMap.of(EntityType.COMPUTE_TIER, ImmutableSet.of(CommodityType.STORAGE_ACCESS,
                    CommodityType.STORAGE_ACCESS_SSD_READ, CommodityType.STORAGE_ACCESS_SSD_WRITE,
                    CommodityType.STORAGE_ACCESS_STANDARD_READ,
                    CommodityType.STORAGE_ACCESS_STANDARD_WRITE, CommodityType.IO_THROUGHPUT,
                    CommodityType.IO_THROUGHPUT_READ, CommodityType.IO_THROUGHPUT_WRITE,
