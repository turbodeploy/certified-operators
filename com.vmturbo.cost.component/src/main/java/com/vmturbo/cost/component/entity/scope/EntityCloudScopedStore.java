...
/**
 * Any store implementing this interface is dependent on the {@link EntityCloudScopedStore}. If the implementing
 ...
 *
 * <p>The consolidation of entity cloud scope into a single store is meant to allow a diverse set of stores
 ...
 */
public interface EntityCloudScopedStore {
}
