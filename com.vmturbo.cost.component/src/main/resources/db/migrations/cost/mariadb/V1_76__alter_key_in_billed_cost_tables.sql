...
ALTER TABLE billed_cost_hourly DROP CONSTRAINT IF EXISTS unique_constraint_billing_item;
...
ALTER TABLE billed_cost_daily DROP CONSTRAINT IF EXISTS unique_constraint_billing_item;
...
ALTER TABLE billed_cost_monthly DROP CONSTRAINT IF EXISTS unique_constraint_billing_item;
