...
/* DROP UNUSED COLUMNS */
ALTER TABLE reserved_instance_coverage_by_hour DROP COLUMN IF EXISTS day_key //
ALTER TABLE reserved_instance_coverage_by_hour DROP COLUMN IF EXISTS month_key //
ALTER TABLE reserved_instance_coverage_by_day DROP COLUMN IF EXISTS month_key //

ALTER TABLE reserved_instance_utilization_by_hour DROP COLUMN IF EXISTS day_key //
ALTER TABLE reserved_instance_utilization_by_hour DROP COLUMN IF EXISTS month_key //
ALTER TABLE reserved_instance_utilization_by_day DROP COLUMN IF EXISTS month_key //
...
CREATE PROCEDURE aggregate_ric_topology(IN rollup_key TINYTEXT COLLATE utf8_general_ci,
                                        IN source_timestamp TIMESTAMP,
                                        IN snapshot_normalization_select TINYTEXT COLLATE utf8_general_ci,
                                        IN destination_table TINYTEXT COLLATE utf8_general_ci)
...
CREATE PROCEDURE aggregate_riu_topology(IN rollup_key TINYTEXT COLLATE utf8_general_ci,
                                        IN source_timestamp TIMESTAMP,
                                        IN snapshot_normalization_select TINYTEXT COLLATE utf8_general_ci,
                                        IN destination_table TINYTEXT COLLATE utf8_general_ci)
