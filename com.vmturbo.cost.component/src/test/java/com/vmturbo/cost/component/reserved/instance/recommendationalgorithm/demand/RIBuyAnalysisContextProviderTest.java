...
public class RIBuyAnalysisContextProviderTest extends MultiDbTestBase {
    /**
     ...
     */
    public RIBuyAnalysisContextProviderTest(boolean configurableDbDialect, SQLDialect dialect)
