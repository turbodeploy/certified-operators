...
public class SQLCloudRateExtractorStoreTest extends MultiDbTestBase {
    /**
     ...
     */
    public SQLCloudRateExtractorStoreTest(boolean configurableDbDialect, SQLDialect dialect)
