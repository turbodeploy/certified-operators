/* File:         market_aggregate.sql                                   */
/* Description:  Asyncronous event driven aggregation of XL stats data */
/*               Creates MySQL aggregate() procedure                   */
/*               Creates aggregate MySQL event EVERY 5 MINUTES         */
...
UPDATE version_info SET version=67.9 WHERE id=1;