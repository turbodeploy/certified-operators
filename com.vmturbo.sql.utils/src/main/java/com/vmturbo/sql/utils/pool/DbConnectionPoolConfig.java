...
public class DbConnectionPoolConfig {
     ...
     */
    private static final long KEEPALIVE_TIME_MSEC_DEFAULT = TimeUnit.MINUTES.toMillis(5);
    ...
    public static HikariDataSource getPooledDataSource(final String schemaName, final String dbUrl,
        ...
        return getPooledDataSource(schemaName, dbUrl, dbUsername, dbPassword, minPoolSize,
                maxPoolSize, null);
    }
    ...
    public static HikariDataSource getPooledDataSource(final String schemaName, final String dbUrl,
            final String dbUsername, final String dbPassword, final int minPoolSize,
            final int maxPoolSize, @Nullable final Long dbKeepAliveIntervalMinutes) {
