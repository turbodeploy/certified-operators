...
public class MultiDB implements PatternMatchingAdapter {
    ...
    /** String constant for character set "utf8". */
    public static final String CHAR_SET_UTF8 = "utf8";

    /** String constant for character set "utf8mb4". */
    public static final String CHAR_SET_UTF8MB4 = "utf8mb4";

    // Immutable set of supported character sets.
    private static final Set<String> SUPPORTED_CHARACTER_SETS =
            ImmutableSet.of(CHAR_SET_UTF8, CHAR_SET_UTF8MB4);
    ...
    public Condition matchRegex(@Nonnull Field<String> fieldToMatch, @Nonnull String regex,
        ...
        if (!SUPPORTED_CHARACTER_SETS.contains(characterSet)) {
            throw new UnsupportedOperationException(
                    String.format("Character set %s is not supported.", characterSet));
        }
        return patternMatchingAdapter.matchRegex(fieldToMatch, regex, positiveMatch, caseSensitive,
                characterSet);
    }
