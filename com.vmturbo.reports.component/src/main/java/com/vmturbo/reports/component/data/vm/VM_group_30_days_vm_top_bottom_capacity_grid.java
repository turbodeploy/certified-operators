...
public class VM_group_30_days_vm_top_bottom_capacity_grid extends GroupsGenerator implements ReportTemplate {
    public VM_group_30_days_vm_top_bottom_capacity_grid(@Nonnull final GroupGeneratorDelegate delegate) {
        super(delegate);
    }
