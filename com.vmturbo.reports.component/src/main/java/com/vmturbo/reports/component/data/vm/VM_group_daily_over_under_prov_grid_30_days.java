...
public class VM_group_daily_over_under_prov_grid_30_days extends GroupsGenerator implements ReportTemplate {
    public VM_group_daily_over_under_prov_grid_30_days(@Nonnull final GroupGeneratorDelegate delegate) {
        super(delegate);
    }
