...
/**
 * Insert report data to vmtdb for Monthly_summary template .
 */
public class Monthly_summary extends GroupsGenerator implements ReportTemplate {

    public Monthly_summary(@Nonnull final GroupGeneratorDelegate groupGeneratorDelegate) {
