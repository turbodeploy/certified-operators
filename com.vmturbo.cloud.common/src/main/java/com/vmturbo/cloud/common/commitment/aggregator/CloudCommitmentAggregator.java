...
/**
 * An aggregator of cloud commitments, based on how commitments may be assigned to coverage
 * entities.
 */
public interface CloudCommitmentAggregator {
     ...
     * @throws AggregationFailureException Thrown if there is a failure in aggregating the
     *         commitment. This may happen in cases where the referenced compute tier cannot be
     *         found or resolving the associated billing family fails.
     */
    ...
    interface CloudCommitmentAggregatorFactory {
        ...
        /**
         * Creates and returns the default aggregator, which is aggregate collected commitments
         * based
         * on coverage assignment.
         *
         * @param tierTopology The cloud topology, which must contain the compute tiers
         *         referenced                     by collected commitments.
        ...
        /**
         * Creates an returns an aggregator, which aggregates commitments based on their identity
         * (on the
         * assigned ID).
         *
         * @param tierTopology The cloud topology, which must contain the compute tiers
    ...
    class AggregationFailureException extends Exception {
        ...
        /**
         * Instantiates a new Aggregation failure exception.
         *
