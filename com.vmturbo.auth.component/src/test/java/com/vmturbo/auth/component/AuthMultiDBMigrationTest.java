...
public class AuthMultiDBMigrationTest extends MultiDBMigrationTest {
     ...
     */
    private static final Pair<Integer, String> SQL_INITIAL_OFFSET = new Pair<>(1, "V1_1__create_widgetset_table.sql");
    private static final String SQL_DEFAULT_PATH = "src/main/resources/db/migration";
    private static final String SQL_MARIA_DB_PATH = "src/main/resources/db/migrations/auth/mariadb";
    private static final String SQL_POSTGRES_PATH = "src/main/resources/db/migrations/auth/postgres";
    ...
    private static final String JAVA_MARIA_DB_PATH = "src/main/java/db/migrations/auth/mariadb";
    private static final String JAVA_POSTGRES_PATH = "src/main/java/db/migrations/auth/postgres";
