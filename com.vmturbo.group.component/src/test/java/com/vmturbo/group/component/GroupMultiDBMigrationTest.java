 ...
 * {@inheritDoc}.
 */
public class GroupMultiDBMigrationTest extends MultiDBMigrationTest {
     ...
     */
    private static final Pair<Integer, String> SQL_INITIAL_OFFSET = new Pair<>(51, "V1_64__change_grouping_charset.sql");
    private static final String SQL_DEFAULT_PATH = "src/main/resources/db/migration";
    private static final String SQL_MARIA_DB_PATH = "src/main/resources/db/migrations/group/mariadb";
    private static final String SQL_POSTGRES_PATH = "src/main/resources/db/migrations/group/postgres";
     ...
     */
    private static final Pair<Integer, String> JAVA_INITIAL_OFFSET = new Pair<>(12, "V1v57MigrateDynamicGroupsOfGroupsMariaDB.java");
    private static final String JAVA_DEFAULT_PATH = "src/main/java/db/migration";
    private static final String JAVA_MARIA_DB_PATH = "src/main/java/db/migrations/group/mariadb";
    private static final String JAVA_POSTGRES_PATH = "src/main/java/db/migrations/group/postgres";
