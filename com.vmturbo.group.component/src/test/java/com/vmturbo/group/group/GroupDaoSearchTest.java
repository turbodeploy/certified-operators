...
/**
 * Unit test to cover {@link GroupDAO} search functionality. This is pretty large a set of tests so
 * they are just extracted to this file of the sake of organization.
 */
@RunWith(Parameterized.class)
public class GroupDaoSearchTest extends MultiDbTestBase {

    /**
     * Provide test parameters values.
     *
    ...
    /**
     * Create a new instance with test parameters.
     *
     ...
     */
    public GroupDaoSearchTest(boolean configurableDbDialect, SQLDialect dialect)
