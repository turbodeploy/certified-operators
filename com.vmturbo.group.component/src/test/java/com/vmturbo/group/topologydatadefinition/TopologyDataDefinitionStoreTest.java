...
public class TopologyDataDefinitionStoreTest {
    ...
    public void setup() throws Exception {
        topologyDataDefinitionIdentityStore =
            new CachingIdentityStore<>(
                ...
                new PersistentTopologyDataDefinitionIdentityStore(),
    ...
    public void testGet() {
        ...
        Optional<TopologyDataDefinition> optTopoDefEntry =
            topologyDataDefinitionStore.getTopologyDataDefinition(manualTopoDataDefEntry.getId());
        assertTrue(optTopoDefEntry.isPresent());
        assertEquals(MANUAL_TOPO_DATA_DEF, optTopoDefEntry.get());

        // Test that get returns Optional.empty for a non existent ID.
        optTopoDefEntry = topologyDataDefinitionStore
            .getTopologyDataDefinition(UNUSED_OID);
        assertFalse(optTopoDefEntry.isPresent());
    }
    ...
    public void testUpdate() {
        ...
        final TopologyDataDefinition updatedManualDef =
            TopologyDataDefinitionTestUtils.createManualTopologyDataDefinition(EntityType.SERVICE,
            MANUAL_ENTITY_NAME, newGroupId);
        final Optional<TopologyDataDefinitionEntry> optUpdatedEntry =
        ...
        assertFalse(topologyDataDefinitionStore.updateTopologyDataDefinition(UNUSED_OID,
            MANUAL_TOPO_DATA_DEF).isPresent());
    }
