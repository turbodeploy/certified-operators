 ...
 */
@Configuration
@Import({PlanOrchestratorDBConfig.class, PlanOrchestratorDBEndpointConfig.class})
public class DbAccessConfig {
    ...
    @Autowired(required = false)
    private PlanOrchestratorDBEndpointConfig planOrchestratorDBEndpointConfig;
    ...
    public DSLContext dsl() throws SQLException, UnsupportedDialectException, InterruptedException {
        return FeatureFlags.POSTGRES_PRIMARY_DB.isEnabled()
                ? planOrchestratorDBEndpointConfig.planEndpoint().dslContext()
                : planOrchestratorDBConfig.dsl();
    }
    ...
    public DataSource dataSource() throws SQLException, UnsupportedDialectException, InterruptedException {
        return FeatureFlags.POSTGRES_PRIMARY_DB.isEnabled()
                ? planOrchestratorDBEndpointConfig.planEndpoint().datasource()
                : planOrchestratorDBConfig.dataSource();
    }
