...
public class PlanExportConfig {
     ...
     */
    @Bean
    public IMessageSender<PlanExportNotification> notificationSender() {
    ...
    public PlanExportNotificationSender planExportNotificationSender() {
        final PlanExportNotificationSender notificationSender =
            new PlanExportNotificationSender(notificationSender());
