 ...
 * {@inheritDoc}.
 */
public class ClusterMgrMultiDBMigrationTest extends MultiDBMigrationTest {
    ...
    private static final Pair<Integer, String>
            SQL_INITIAL_OFFSET = new Pair<>(1, "V1_2__fix_timestamp_columns_clustermgr.sql");
    private static final String SQL_DEFAULT_PATH = "src/main/resources/db/migration";
    private static final String SQL_MARIA_DB_PATH = "src/main/resources/db/migrations/clustermgr/mariadb";
    private static final String SQL_POSTGRES_PATH = "src/main/resources/db/migrations/clustermgr/postgres";
    ...
    private static final String JAVA_MARIA_DB_PATH = "src/main/java/db/migrations/clustermgr/mariadb";
    private static final String JAVA_POSTGRES_PATH = "src/main/java/db/migrations/clustermgr/postgres";
