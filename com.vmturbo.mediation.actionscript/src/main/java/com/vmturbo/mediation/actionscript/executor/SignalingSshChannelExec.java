 ...
 */
class SignalingSshChannelExec extends ChannelExec {

    SignalingSshChannelExec(final @Nonnull String command) {
        super(command);
    }
     ...
     */
    void signal(final @Nonnull String signal) throws IOException {
