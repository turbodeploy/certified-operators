...
class ScriptRunner {
    ...
    ScriptRunner waitForCompletion() throws ExecutionException {
        System.out.println("Waiting for action script " + testAccess.getScriptName() + " to terminate");
        ...
        System.out.println("Action script " + testAccess.getScriptName() + " has terminated");
        return this;
    }
    ...
    ScriptRunner checkExit(final @Nullable Integer exitStatus, final @Nullable String exitSignal, final @Nullable Class<? extends Throwable> exceptionClass) {
        ...
        assertNotNull(comp);
        Assert.assertEquals("Unexpected exit status", exitStatus, comp.getExitStatus());
        Assert.assertEquals("Unexpected exit signal", exitSignal, comp.getExitSignal());
        ...
        Assert.assertEquals("Unexpected exit exception", exceptionClass, actualException != null ? actualException.getClass() : null);
        return this;
    }
    ...
    ScriptRunner sleep(final int seconds) {
        System.out.println("Script " + testAccess.getScriptName() + " pausing for " + seconds + " seconds");
