...
public enum CloudService {
    ...
    AWS_A4B("aws::CS::A4B", "A4B", SDKProbeType.AWS),
    ...
    AWS_CLOUD_HSM("aws::CS::CloudHSM", "Cloud HSM", SDKProbeType.AWS),
    AWS_CODE_BUILD("aws::CS::CodeBuild", "Code Build", SDKProbeType.AWS),
    AWS_CONTACT_CENTER_TELECOMM("aws::CS::ContactCenterTelecomm", "Contact Center Telecomm", SDKProbeType.AWS),
    AWS_ELASTIC_MAP_REDUCE("aws::CS::ElasticMapReduce", "Elastic Map Reduce", SDKProbeType.AWS),
    AWS_OPS_WORKS("aws::CS::OpsWorks", "Ops Works", SDKProbeType.AWS),
    AWS_SNOWBALL_EXTRA_DAYS("aws::CS::SnowballExtraDays", "Snowball Extra Days", SDKProbeType.AWS),
    ...
    AWS_INGESTION_SERVICE_SNOWBALL("aws::CS::IngestionServiceSnowball", "Ingestion Service Snowball", SDKProbeType.AWS),
    AWS_IOT_DEVICE_DEFENDER("aws::CS::IoTDeviceDefender", "IoT Device Defender", SDKProbeType.AWS),
    ...
    AWS_CODE_GURU("aws::CS::CodeGuru", "Code Guru", SDKProbeType.AWS),
    AWS_DEVICE_FARM("aws::CS::AWSDeviceFarm", "AWS Device Farm", SDKProbeType.AWS),
    AWS_INGESTION_SERVICE("aws::CS::IngestionService", "Ingestion Service", SDKProbeType.AWS),
    ...
    AWS_IOT_DEVICE_MANAGEMENT("aws::CS::IoTDeviceManagement", "IoT Device Management", SDKProbeType.AWS),
