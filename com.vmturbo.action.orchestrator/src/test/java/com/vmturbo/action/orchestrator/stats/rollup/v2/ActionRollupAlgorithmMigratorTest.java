...
public class ActionRollupAlgorithmMigratorTest extends MultiDbTestBase {
     ...
     */
    public ActionRollupAlgorithmMigratorTest(boolean configurableDbDialect, SQLDialect dialect)
