...
public class ActionsRpcServiceTest {
    ...
    private static final long ACTION_ID = 8822L;
    ...
    public void setup() {
        ...
        actionsRpcService = new ActionsRpcService(clock,
          actionStorehouse, actionApprovalManager, actionTranslator, paginatorFactory, historicalActionStatReader,
          currentActionStatReader, userSessionContext, acceptedActionsStore, rejectedActionsStore, 10);
    ...
    public void testAcceptAction() throws ExecutionInitiationException {
        // ARANGE
        Action action = executableActivateAction(ACTION_ID, 13L);
    ...
    private Action executableActivateAction(long id, long targetId) {
        final ActionDTO.Action action = ActionDTO.Action.newBuilder()
                .setId(id)
                .setDeprecatedImportance(0)
                .setExecutable(true)
