...
public class ActionTargetByProbeCategoryResolverTest {
    ...
    public void setup() throws CommunicationException, TopologyProcessorException {
        ...
        targetResolver = new ActionTargetByProbeCategoryResolver(topologyProcessor);
        ...
        final ProbeInfo probe1 = createProbe("STORAGE");
        // It has 1 priority
        final ProbeInfo probe2 = createProbe("LOAD BALANCER");
        // It has 8 priority
        final ProbeInfo probe3 = createProbe("FLOW");
        final ProbeInfo unknownCategoryProbe = createProbe("UNKNOWN"); // We haven't this category
    ...
    @Nonnull
    private ProbeInfo createProbe(@Nonnull String category) {
