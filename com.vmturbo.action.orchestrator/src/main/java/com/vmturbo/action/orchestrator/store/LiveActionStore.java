    ...
    public static final Predicate<ActionView> VISIBILITY_PREDICATE = actionView ->
        !ActionMode.DISABLED.equals(actionView.getMode()) &&
            (!ActionState.READY.equals(actionView.getState()) || actionView
                    .determineExecutability()) && isSupportedByProbe(actionView);

    private static boolean isSupportedByProbe(ActionView actionView) {
        return actionView.getRecommendation().getSupportingLevel() != SupportLevel.UNSUPPORTED;
    }
