...
public class DockerEnvironment {
    ...
    static final ImmutableMap<String, String> ENVIRONMENT_VARIABLES =
        new ImmutableMap.Builder<String, String>()
            ...
            .put("MEDIATION_AWSCLOUDBILLING_PORT", "8080")
            .put("MEDIATION_AWSCLOUDBILLING_DEBUG_PORT", "8000")
            ...
            .put("MEDIATION_ORACLE_PORT", "8080")
            .put("MEDIATION_ORACLE_DEBUG_PORT", "8000")
            ...
            .put("MEDIATION_AWSCLOUDBILLING_XMX_MB", "384")
            .put("MEDIATION_AWSCLOUDBILLING_MEM_LIMIT_MB", "512")
            ...
            .put("MEDIATION_AWSCLOUDBILLING_SYSTEM_PROPERTIES", "")
            ...
            .put("MEDIATION_WEBSPHERE_SYSTEM_PROPERTIES", "")
