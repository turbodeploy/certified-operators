...
public class RepositoryDiagnosticControllerTest {
    @Configuration
    @EnableWebMvc
    static class ContextConfiguration {
        @Bean
        public RepositoryDiagnosticController controller() {
            return new RepositoryDiagnosticController(diagnosticsHandler());
        }

        @Bean
        public RepositoryDiagnosticsHandler diagnosticsHandler() {
            return mock(RepositoryDiagnosticsHandler.class);
        }
    }
    ...
    private RepositoryDiagnosticsHandler handlerMock;

    @Before
    public void setup() throws Exception {
        mockMvc = MockMvcBuilders.webAppContextSetup(wac).build();
        handlerMock = wac.getBean(RepositoryDiagnosticsHandler.class);
    }
