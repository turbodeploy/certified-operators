...
public class ConvertToTopologyDTOTest {
    ...
    public void testConvertDesktopPoolInfoRepoDTO() {
        ...
        desktopPoolInfoRepoDTO.setProvisionType(DesktopPoolProvisionType.ON_DEMAND.name());
        desktopPoolInfoRepoDTO.setCloneType(DesktopPoolCloneType.LINKED.name());
        desktopPoolInfoRepoDTO.setAssignmentType(DesktopPoolAssignmentType.DYNAMIC.name());
