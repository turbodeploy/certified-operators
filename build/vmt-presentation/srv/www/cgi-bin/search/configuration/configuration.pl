...
$INDEXER_START = 'C:/wamp/www/VMT/help/'; # re-index
...
#$BASE_URL = '../../VMT/help/';
$BASE_URL = '../../../com.vmturbo.UI/help/';

# The url where ksearch.cgi is located
$SEARCH_URL = "http://localhost/VMT/search/ksearch.cgi";
...
$KSEARCH_DIR = '/srv/www/cgi-bin/search/'; # re-index
...
@FILE_EXTENSIONS = ("html", "htm", "php", "php2",); # re-index
...
$RESULTS_TITLE = '<div class="content"><h2>Your Search Results</h2></div>';
