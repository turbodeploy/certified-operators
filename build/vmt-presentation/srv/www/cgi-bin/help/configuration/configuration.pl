# KSEARCH v 1.6 CONFIGURATION FILE ####################
#
...
#$INDEXER_START = 'C:/wamp/www/com.vmturbo.UI/help/'; # re-index
#$INDEXER_START = '/var/www/VMT_Help/'; # re-index
#$INDEXER_START = 'C:/VMTurbo/VMT_OpMgrProject/DoxyOutput/html/'; # re-index
#$INDEXER_START = 'C:/_programming/DITA/DITA-OT1.6.3/samples/_StructOutput1/'; # re-index
$INDEXER_START = 'C:/_programming/VMTurbo/Tools/BlazeDS/tomcat/webapps/vmturbo/com.vmturbo.UI/help/_Topics/'; # re-index

# The base url of your site being indexed
# Be sure it corresponds to the $INDEXER_START directory (end with /)
#$BASE_URL = 'http://localhost/VMT/help/';
#$BASE_URL = '../../VMT/help/';
#$BASE_URL = 'arf2/VMT_Help/';
$BASE_URL = '';

# The url where ksearch.cgi is located
#$SEARCH_URL = "http:/10.10.172.98/cgi-bin/search/ksearch.cgi";
#$SEARCH_URL = "http://www.YourDomain.com/search/ksearch.cgi";

# The full-path of the ksearch directory (end with /) E:\wamp\www\help
# This is the location of the search CGI script...
#$KSEARCH_DIR = 'C:/_programming/VMTurbo/Tools/BlazeDS/tomcat/webapps/vmturbo/cgi-bin/help/'; # re-index
#$KSEARCH_DIR = 'E:/wamp/www/help/'; # re-index
#$KSEARCH_DIR = 'C:/VMTurbo/VMT_OpMgrProject/DoxyProcessFolder/FullSearchSetup/search/'; # re-index
#$KSEARCH_DIR = 'C:/wamp/www/cgi-bin/search/'; # re-index
#$KSEARCH_DIR = '/var/www/cgi-bin/search/'; # re-index
$KSEARCH_DIR = './'; # re-index
...
@VALID_REFERERS = ("http://www.YourDomain.com");
$INDEXER_URL = "http://www.YourDomain.com/search/indexer.cgi";
$PASSWORD = "YourPasswordHere"; # required to access INDEXER.CGI
...
@FILE_EXTENSIONS = ("dita", "xml"); # re-index
...
#$USE_DBM = 0; # re-index -- Deleted all references from DITA_Search.pl
...
$IGNORE_COMMON_TERMS = 80; # re-index
...
$LOG_SEARCH = 'C:/wamp/www/VMT/search/database/search_log.txt';
...
$RESULTS_TITLE = '<div class="content"><h2>Search Results</h2></div>';
...
$TRANSLATE_CHARACTERS = 0;	# re-index if changing from 0; # edit-help-template
...
$TEMPLATE_DIR = $KSEARCH_DIR;
#$TEMPLATE_DIR = $KSEARCH_DIR.'templates/';
$KSEARCH_TEMPLATE = $KSEARCH_DIR.'search_template.html';
