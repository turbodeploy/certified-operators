    ...
    public void testAcceptRollupWithActionGroup() {
        ...
        ActionRollupNotification rollupNotification = ActionRollupNotification.newBuilder()
                ...
                .addActionGroups(ActionGroup.newBuilder()
                        ...
                        .setActionSeverity(Severity.MAJOR)
        ...
        assertEquals(com.vmturbo.extractor.schema.enums.Severity.MAJOR,
                actionGroupRecord.get(ActionStatsModel.ActionGroup.SEVERITY));
