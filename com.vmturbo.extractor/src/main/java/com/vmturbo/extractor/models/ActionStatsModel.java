...
public class ActionStatsModel {
    ...
    public static class ActionGroup {
        ...
        /**
         * The SEVERITY column: the severity of action to which the stats belong within the scope.
         */
        public static final Column<Severity> SEVERITY =
                new Column<>(Tables.ACTION_GROUP.SEVERITY, ColType.SEVERITY);
        ...
        public static final Table TABLE = Table.named(Tables.ACTION_GROUP.getName())
                .withColumns(ID, TYPE, CATEGORY, SEVERITY, RISKS)
                .build();
