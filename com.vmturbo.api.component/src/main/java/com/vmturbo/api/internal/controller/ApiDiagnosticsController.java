...
public class ApiDiagnosticsController {
    ...
    private final ApiDiagnosticsHandler diagnostics;

    public ApiDiagnosticsController(@Nonnull final ApiDiagnosticsHandler diagnostics) {
        this.diagnostics = Objects.requireNonNull(diagnostics);
    }

    /**
     * Get a zip file containing the internal state of the API component.
     *
     * @return a zip file containing the internal state of the API component.
     * @throws IOException If the zip file cannot be generated.
     */
    ...
    /**
     * Restore the internal state from diagnostics.
     *
     * @param inputStream An input stream containing the diagnostics for this component.
     * @return A {@link ResponseEntity} describing the success or failure of the operation.
     * @throws IOException
     */
