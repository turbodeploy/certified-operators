...
public enum MarketMode {
    ...
    M2withSMAActions,
    /**
     * only run SMA to generate cloud VM scale actions without relinquishing..  All other actions are generated by M2.
     */
    SMALite;
    ...
    public static boolean isEnableSMA(MarketMode mode) {
        return mode == SMAOnly || mode == M2withSMAActions || mode == SMALite;
    }
}
