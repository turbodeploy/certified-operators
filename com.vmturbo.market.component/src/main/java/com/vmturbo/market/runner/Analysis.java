...
.    */
    ...
    private void runMigratedWorkloadCloudCommitmentAnalysis(@Nonnull CloudTopology<TopologyEntityDTO> projectedCloudTopology,
        ...
        Optional<TopologyEntityDTO> masterBusinessAccount = getMasterBusinessAccount(projectedCloudTopology, projectedEntities, projectedTraderDTO);
    ...
    /**
     * Returns the master business account in the specified projected cloud topology.
     *
     * TODO: this currently returns the first business account found in the projected topology; we need to find the actual
     * TODO: master business account
     *
     * @param projectedCloudTopology    The projected cloud topology, generated by the market
     * @param projectedEntities         A map of the projected entities
     * @param projectedTraderDTO        A list of the TraderTOs, used to find relationships between entities
     * @return                          An optional wrapping the master business account, if found
     */
    Optional<TopologyEntityDTO> getMasterBusinessAccount(@Nonnull CloudTopology<TopologyEntityDTO> projectedCloudTopology,
                                        @NonNull Map<Long, ProjectedTopologyEntity> projectedEntities,
                                        @NonNull List<TraderTO> projectedTraderDTO) {
