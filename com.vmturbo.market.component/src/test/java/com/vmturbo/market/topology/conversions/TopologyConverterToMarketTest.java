...
public class TopologyConverterToMarketTest {
    ...
    public void testConvertDTOs() {
        ...
        // Which will result in getStorageMoveCost
        // returning 0 rather than 0.02, due to it returning a float rather than a double
        assertEquals(0, dsShoppingList.getStorageMoveCost(), epsilon);
    ...
    public void testCommodityBoughtFromAProviderWithPercentileUtilization() throws IOException {
        ...
        Collection<TraderTO> traderTOs = new TopologyConverter(REALTIME_TOPOLOGY_INFO, false,
                ...
                ccd, CommodityIndex.newFactory(), tierExcluderFactory,
                consistentScalingHelperFactory, reversibilitySettingFetcher,
                MarketAnalysisUtils.PRICE_WEIGHT_SCALE, cloudTopology, false, false, false, 0.5f)
                .convertToMarket(topologyDTOs);
