...
public class MarketMultiDBMigrationTest extends MultiDBMigrationTest {
     ...
     */
    private static final Pair<Integer, String> SQL_INITIAL_OFFSET = new Pair<>(0, "");
    private static final String SQL_DEFAULT_PATH = "src/main/resources/db/migration";
    private static final String SQL_MARIA_DB_PATH = "src/main/resources/db/migrations/market/mariadb";
    private static final String SQL_POSTGRES_PATH = "src/main/resources/db/migrations/market/postgres";
    ...
    private static final String JAVA_MARIA_DB_PATH = "src/main/java/db/migrations/market/mariadb";
    private static final String JAVA_POSTGRES_PATH = "src/main/java/db/migrations/market/postgres";
