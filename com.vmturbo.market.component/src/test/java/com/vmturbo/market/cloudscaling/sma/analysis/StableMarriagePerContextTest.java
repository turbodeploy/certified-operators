...
public class StableMarriagePerContextTest {
    ...
    public void testComputeFamilyToTemplateMap() {
        ...
        SMATemplate f1t1 = new SMATemplate(templateOid, "f1." + templateOid, "f1", 2, null);
        ...
        templateOid++;
        SMATemplate f1t2 = new SMATemplate(templateOid, "f1." + templateOid, "f1", 4, null);
        ...
        templateOid++;
        SMATemplate f1t3 = new SMATemplate(templateOid, "f1." + templateOid, "f1", 8, null);
        ...
        SMATemplate f2t1 = new SMATemplate(templateOid, "f1." + templateOid, "f2", 2, null);
        ...
        SMATemplate f2t4 = new SMATemplate(templateOid, "f1." + templateOid, "f2", 16, null);
