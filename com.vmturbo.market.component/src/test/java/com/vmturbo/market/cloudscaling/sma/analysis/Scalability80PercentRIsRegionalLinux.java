...
public class Scalability80PercentRIsRegionalLinux {
    /**
     * number of vms is 80% of the number of ris. all ris are isf.
     */
    @Ignore
    @Test
    public void testScaling80PerentRIsZonalWindows() {
        int templates = 175;
        int families = 26;
        int zones = 4;
        int accounts = 1;
