...
BEGIN
  IF (SELECT NOT EXISTS(SELECT * FROM information_schema.columns WHERE table_schema = (SELECT DATABASE()) AND table_name = 'percentile_blobs' AND column_name = 'chunk_index'))
  THEN
