--
-- This migration creates stats tables for Application Component Spec:
--    - app_component_spec_stats_latest
--    - app_component_spec_stats_by_hour
--    - app_component_spec_stats_by_day
--    - app_component_spec_stats_by_month

CREATE TABLE IF NOT EXISTS `app_component_spec_stats_latest` (
...
CREATE TABLE IF NOT EXISTS `app_component_spec_stats_by_hour` (
...
CREATE TABLE IF NOT EXISTS `app_component_spec_stats_by_day` (
  `snapshot_time` datetime NOT NULL,
  `uuid` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `producer_uuid` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `property_type` varchar(36) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `app_component_spec_stats_by_month` (
  `snapshot_time` datetime NOT NULL,
  `uuid` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `producer_uuid` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `property_type` varchar(36) COLLATE utf8_unicode_ci DEFAULT NULL,
