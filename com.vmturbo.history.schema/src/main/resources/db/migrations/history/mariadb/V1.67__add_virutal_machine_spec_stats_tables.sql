--
-- This migration creates stats tables for Virtual machine spec:
--    - virtual_machine_spec_stats_latest
--    - virtual_machine_spec_stats_by_hour
--    - virtual_machine_spec_stats_by_day
--    - virtual_machine_spec_stats_by_month
--

CREATE TABLE IF NOT EXISTS `virtual_machine_spec_stats_latest` (
  ...
  KEY `snapshot_time_hour_key` (`snapshot_time`, `hour_key`),
  KEY `uuid` (`uuid`),
...
CREATE TABLE IF NOT EXISTS `virtual_machine_spec_stats_by_hour` (
...
CREATE TABLE IF NOT EXISTS `virtual_machine_spec_stats_by_day` (
  `snapshot_time` datetime NOT NULL,
  `uuid` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `producer_uuid` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `property_type` varchar(36) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `virtual_machine_spec_stats_by_month` (
  `snapshot_time` datetime NOT NULL,
  `uuid` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `producer_uuid` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `property_type` varchar(36) COLLATE utf8_unicode_ci DEFAULT NULL,
