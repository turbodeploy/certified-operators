...
public class HistoryMultiDBMigrationTest extends MultiDBMigrationTest {
     ...
     */
    private static final Pair<Integer, String> SQL_INITIAL_OFFSET = new Pair<>(80, "V1.61__fix_cnt_indexes.sql");
    private static final String SQL_DEFAULT_PATH = "src/main/resources/db/migration";
    private static final String SQL_MARIA_DB_PATH = "src/main/resources/db/migrations/history/mariadb";
    private static final String SQL_POSTGRES_PATH = "src/main/resources/db/migrations/history/postgres";
     ...
     */
    private static final Pair<Integer, String> JAVA_INITIAL_OFFSET = new Pair<>(2, "V1v35v1InitializeAvailableHistoryTimesTableMariaDB.java");
    private static final String JAVA_DEFAULT_PATH = "src/main/java/db/migration";
    private static final String JAVA_MARIA_DB_PATH = "src/main/java/db/migrations/history/mariadb";
    private static final String JAVA_POSTGRES_PATH = "src/main/java/db/migrations/history/postgres";
