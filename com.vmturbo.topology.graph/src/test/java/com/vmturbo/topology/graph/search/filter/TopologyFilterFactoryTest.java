...
public class TopologyFilterFactoryTest {
    ...
    private static final TestGraphEntity USER_DEFINED_WITH_TWO_DISCOVERED_TARGETS =
    ...
    public void testSearchFilterForUserDefinedEntitiesNotMatch() {
        final SearchFilter searchCriteria = SearchFilter.newBuilder()
                    .setPropertyFilter(Search.PropertyFilter.newBuilder()
                        .setPropertyName(SearchableProperties.USER_DEFINED_ENTITY)
                        .setStringFilter(StringFilter.newBuilder()
        ...
        assertTrue(propertyFilter.test(USER_DEFINED_WITH_TWO_DISCOVERED_TARGETS));
    }
    ...
    public void testSearchFilterForUserDefinedEntitiesMatch() {
        ...
        assertFalse(propertyFilter.test(USER_DEFINED_WITH_TWO_DISCOVERED_TARGETS));
    }
