...
import com.vmturbo.protoc.spring.rest.generator.Descriptors.EnumDescriptor;
import com.vmturbo.protoc.spring.rest.generator.Descriptors.MessageDescriptor;
import com.vmturbo.protoc.spring.rest.generator.Descriptors.ServiceDescriptor;
...
public class Registry {
    ...
    @Nonnull
    public ServiceDescriptor registerService(final FileDescriptorProcessingContext context,
    ...
    @Nonnull
    public EnumDescriptor registerEnum(final FileDescriptorProcessingContext context,
    ...
    @Nonnull
    public MessageDescriptor registerMessage(final FileDescriptorProcessingContext context,
